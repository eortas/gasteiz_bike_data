...
def main():
    print("Cargando datos crudos desde historico.csv...")
    ...
    # Convertimos el timestamp a tipo datetime
    ...
    # Eliminamos las filas con valores nulos generadas por los desplazamientos temporales (shift)
    df_clean = df.dropna().reset_index(drop=True)
    
    # Convertimos id_estacion a tipo category para soporte nativo en LightGBM
